...
@torch.no_grad()
def compute_eval_metrics(model, dataloader, device, size, tokenizer, is_pairwise=False, is_test=False):
    """
    ...
    for batch in tqdm(dataloader):
        ...
        input_decoded += [tokenizer.decode(token_ids, skip_special_tokens=True) for token_ids in batch['input_ids']]
