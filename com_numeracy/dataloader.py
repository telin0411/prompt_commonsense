...
class Com2SenseDataset(BaseDataset):
    ...
    def _preprocess(self, data_dir):
        ...
        if self.split == 'train' or 'dev':
            df['numeracy'] = df['numeracy'].apply(lambda l: label2int[l])
            ...
            for pair in raw_data:
                sample_1 = dict(_id=pair['_id'], text=pair['sent_1'], label=pair['numeracy'])
                sample_2 = dict(_id=pair['_id'], text=pair['sent_2'], label=pair['numeracy'])
