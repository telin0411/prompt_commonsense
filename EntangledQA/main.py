...
def main():
    ...
    if args.mode == 'train':
        ...
        dev_a_loader = DataLoader(dev_a_datasets, batch_size, shuffle=True, drop_last=True,
                                  num_workers=args.num_workers)
        dev_b_loader = DataLoader(dev_b_datasets, batch_size, shuffle=True, drop_last=True,
                                  num_workers=args.num_workers)
        ...
        val_size = dev_a_datasets.__len__()
            ...
            for batch in tqdm(train_loader):
                ...
                if curr_step % args.log_interval == 0:
                    ...
                    if dev_a_datasets:
                        ...
                        writer.add_scalar('Val/Loss', dev_a_metrics['loss'], curr_step)
                        writer.add_scalar('Val/Accuracy', dev_a_metrics['accuracy'], curr_step)
                        writer.add_scalar('Val/Loss', dev_b_metrics['loss'], curr_step)
                        writer.add_scalar('Val/Accuracy', dev_b_metrics['accuracy'], curr_step)
