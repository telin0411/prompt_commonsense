...
class BaseDataset(Dataset):
    ...
    def __init__(self, split, tokenizer, max_seq_len=128, text2text=True, uniqa=False):
        ...
        self.uniqa = uniqa
        # Tokenizer
        self.tokenizer = AutoTokenizer.from_pretrained(self.tok_name, additional_special_tokens=['<domain>', '<scenario>'])
    ...
    def __getitem__(self, idx):
        ...
        if self.text2text:
            ...
            text = f'{cls} {domain} {scenario} {text}'
    ...
    def _preprocess(self, data_dir):
        ...
        for pair in raw_data:
            sample_1 = dict(_id=pair['_id'], text=pair['sent_1'], label=pair['label_1'],
                            domain=pair['domain'], scenario=pair['scenario'])
