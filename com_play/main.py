...
def main():
    ...
    # Experiment params
    parser.add_argument('--mode', default='play', type=str, help='train or test mode', choices=['train', 'test', 'play'])
    ...
    parser.add_argument('--ckpt', default='/nas/home/yixiaoli/project/Com2Sense/results_log/com2sense/roberta_large/bs_16_400e_6/ep_394_stp_39.4k_acc_61.0000_roberta_large.pth', type=str, help='path to model checkpoint .pth file')
    ...
    parser.add_argument('--sentence', type=str, default='hello world', help='input a sentence to classify')
    ...
    if args.mode == 'train':
        ...
        tokens = tokenizer.encode_plus(text=f'{tokenizer.cls_token} {args.sentence}',
        ...
        attn_mask = torch.tensor(tokens['attention_mask']).unsqueeze(0)
