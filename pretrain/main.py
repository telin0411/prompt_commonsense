...
def main():
    parser = argparse.ArgumentParser(description='Pretraining on Large Corpus')
    ...
    if args.mode == 'train':
        ...
        # Dataset & Dataloader
        train_datasets = corpus(file_path=args.train_file, tokenizer=args.model,
                                input_seq_len=args.seq_len, target_seq_len=128)

        val_datasets = corpus(file_path=args.dev_file, tokenizer=args.model,
                              input_seq_len=args.seq_len, target_seq_len=128)
        ...
        # Dataloader
        test_dataset = corpus(args.test_file, tokenizer=args.model, input_seq_len=args.seq_len, target_seq_len=128)
