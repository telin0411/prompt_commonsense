...
def pred_entity(model, dataloader, device, tokenizer, args):
    ...
    for batch in dataloader:
        ...
        one_hot = torch.nn.functional.one_hot(batch['noun_ids'], label_logits.shape[1])
        ...
        acc.append(compute_precision(batch_pred_words, batch['entity_string'], batch['sent_string']))
